...
void EnermyGunRotatingSwavelingState::onUpdate()
{
	if (getDistanceToClose() == true)
	{
		...
		if (iFrame > 40)
		{
			...
			switch (iCurentIndex)
			{
			case 1: pData->Bullets.push_back(new PlayerMBullet(pData->x, pData->y - pData->body.height, true, fAngle)); break;
			case 2: pData->Bullets.push_back(new PlayerMBullet(pData->x + pData->body.width * 1 / 4, pData->y - pData->body.height, true, fAngle)); break;
			case 3:pData->Bullets.push_back(new PlayerMBullet(pData->x + pData->body.width * 1 / 2, pData->y - pData->body.height * 3 / 4, true, fAngle)); break;
			case 4: pData->Bullets.push_back(new PlayerMBullet(pData->x + pData->body.width, pData->y - pData->body.height / 2, true, fAngle)); break;
			case 5:pData->Bullets.push_back(new PlayerMBullet(pData->x + pData->body.width / 2, pData->y - pData->body.height * 1 / 4, true, fAngle)); break;
			case 6:pData->Bullets.push_back(new PlayerMBullet(pData->x + pData->body.width*1/4, pData->y , true, fAngle)); break;
			case 7:pData->Bullets.push_back(new PlayerMBullet(pData->x, pData->y , true, fAngle)); break;
			case 8:pData->Bullets.push_back(new PlayerMBullet(pData->x -pData->body.width * 1 / 4, pData->y, true, fAngle)); break;
			case 9:pData->Bullets.push_back(new PlayerMBullet(pData->x - pData->body.width * 1 / 2, pData->y - pData->body.height * 1 / 4, true, fAngle)); break;
			case 10:pData->Bullets.push_back(new PlayerMBullet(pData->x - pData->body.width*1/2, pData->y - pData->body.height * 1 / 2, true, fAngle)); break;
			case 11:pData->Bullets.push_back(new PlayerMBullet(pData->x - pData->body.width*1/2, pData->y - pData->body.height * 3 / 4, true, fAngle)); break;
			case 12:pData->Bullets.push_back(new PlayerMBullet(pData->x - pData->body.width * 1 / 4, pData->y - pData->body.height, true, fAngle)); break;
			default:
				break;
			}
			iFrame = 0;
